...
class labLexer(Lexer):
    ...
    literalNames = [ "<INVALID>",
            "'fn'", "'set'", "'if'", "'while'", "'return'", "'int'", "'float'", 
            "'bool'", "'true'", "'false'", "'('", "')'" ]

    symbolicNames = [ "<INVALID>",
            "FN", "SET", "IF", "WHILE", "RETURN", "INT_T", "FLOAT_T", "BOOL_T", 
            "TRUE_T", "FALSE_T", "LPAREN", "RPAREN", "FLOAT", "INT", "IDENT", 
            "WS" ]

    ruleNames = [ "FN", "SET", "IF", "WHILE", "RETURN", "INT_T", "FLOAT_T", 
                  "BOOL_T", "TRUE_T", "FALSE_T", "LPAREN", "RPAREN", "FLOAT", 
                  "INT", "DIGITS", "IDENT", "WS" ]
